...
public interface CandidateProfileRepository extends JpaRepository<CandidateProfile, UUID> {
  ...
  @Query(
      value =
          "SELECT c.id, c.first_name AS firstName, c.last_name as lastName, p.name_en AS location, c.avatar_url AS avatarUrl, c.gender, c.education FROM candidate_profile c"
